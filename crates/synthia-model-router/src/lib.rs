//! Synthia Model Router: intelligent model selection based on task complexity and conversation state
//!
//! This crate provides functionality to route tasks to appropriate models
...
//!     DefaultModelRouter, ModelConfig,
