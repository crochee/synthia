...
**Note**: Cancellation propagation to the tool's `call_with_sandbox()` is specified in the `tool-cancellation-propagation` capability. This requirement covers the orchestrator-side cleanup only.
