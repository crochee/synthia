...
Defines the `GET /api/v2/sessions/{id}/subagents` endpoint that lists child sessions (subagents) for a given parent session, with user isolation and cursor pagination.
