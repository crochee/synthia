# landlock-fallback Specification

## Purpose

Define the Linux Landlock LSM as a fallback sandbox backend for the Synthia agent runtime. This specification covers runtime ABI detection, workspace-scoped filesystem access control, Cargo feature gating, and command wrapping semantics when bubblewrap is unavailable.
