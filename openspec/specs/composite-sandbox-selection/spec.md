# composite-sandbox-selection Specification

## Purpose

Define `CompositeSandboxManager`, a prioritized chain of `SandboxManager` backends that selects the first usable sandbox attempt. This enables graceful fallback from bubblewrap to Landlock while preserving fail-closed semantics.
